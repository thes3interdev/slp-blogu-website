			...
			<div className="mx-auto flex max-w-7xl flex-col px-4">
				<div className="items-center justify-between text-center text-slate-100 md:flex">
					<Link to="/" className="inline-flex items-center">
						<span className="ml-2 text-xl font-semibold uppercase tracking-wide">Blogu</span>
					</Link>
				...
				<div className="flex flex-col items-center justify-between text-slate-100 md:flex-row">
					<p className="pt-2 text-sm">© Copyright {currentYear} Superior Software Solutions LTD.</p>

					<div className="flex items-center justify-center space-x-2 pt-2 text-2xl sm:max-w-xs">
						<a href="#">
